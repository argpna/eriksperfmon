...
def main():
    ...
    parser.add_argument("--remove", action="store_true", help="Remove the perfmon route instead of upserting it")
    ...
    if existing_perfmon is not None:
        keys = ["receiver", "group_by", "group_wait", "group_interval", "repeat_interval"]
